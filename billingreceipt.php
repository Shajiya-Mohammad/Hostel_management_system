...
<div class="card-body">
	<div class="row mb-4">
			<div class="col-sm-12">
				...
				<div> (ANDHRA  UNIVERSITY, Maddilapalem, Visakhapatnam, AP)</div>
...
<br>
			...
			<div class="col-sm-12">
			<div style="font-size:16px;"><b>Received from Mr/Mrs.  <u ><?php echo $rsadmission['name']; ?></u> Collected Amount <u >Rs.<?php echo $rsbilling[4]; ?></u>  from <u><?php echo date("d-M-Y",strtotime($rsadmission['start_date'])); ?></u>  to <u ><?php echo date("d-M-Y",strtotime($rsadmission['end_date'])); ?></u></b></div>
			</div>
	</div>
